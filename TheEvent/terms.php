...
<body>
    ...
    <div class="container">
        <div class="content">
            ...
            <p>Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with
                and be bound by the following terms and conditions of use, which together with our privacy policy
                govern our relationship with you in relation to this website. If you disagree with any part of
                these terms and conditions, please do not use our website.</p>
            <p>The term 'company' or 'us' or 'we' refers to the owner of the website. The term 'you' refers to the
            ...
            <ul>
                ...
                <li>This website uses cookies to monitor browsing preferences. If you do allow cookies to be used,
                    personal information may be stored by us for use by third parties.</li>
            ...
            <p>All trademarks reproduced in this website, which are not the property of, or licensed to the operator,
            ...
            <p>Your use of this website and any dispute arising out of such use of the website is subject to the laws
                of England, Northern Ireland, Scotland, and Wales.</p>
        </div>
    </div>

    <div class="footer">
        <p>&copy; <?php echo date("Y"); ?> Medancer Initiative Rwanda. All rights reserved.</p>
    </div>
