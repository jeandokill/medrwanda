        ...
        <span>MEDCANCER</span>
            ...
            <nav id="navbar" class="navbar">
              <ul>
                ...
                <li><a  href=".php">Awareness</a></li>
                <li><a  href=".php">Services</a></li>
                <li><a  href=".php">Get involved</a></li>
        ...
        <div class="row">
            <div class="col-lg-8 entries">
                ...
                if (!empty($blogPost)) {
                    ...
                    echo "<img src='/EVENT/admin/blog/" .$blogPost['image'] . "' alt='' class='img-fluid'>";
                    echo "</div>";
                    ...
                    echo "<p class='blog-paragraph'>" .$blogPost['paragraph'][0] . "</p>";
                    ...
                    echo "<img src='/EVENT/admin/blog/" .$blogPost['content_image'] . "' alt='' class='img-fluid'>";
                    ...
                    echo "<img src='/EVENT/admin/blog/" .$blogPost['author_image'] . "' class='rounded-circle float-left' alt='author image'>";
